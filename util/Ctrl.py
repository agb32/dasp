            ...
            if addDir:#add a listing of all elements of the object...
                for a in dir(sciobj):
                    if a[:2]!="__":
                        ...
                        if (type(obj)==numpy.ndarray and obj.dtype not in [numpy.complex64,numpy.complex128]) or ((type(obj)==Numeric.ArrayType) and (obj.typecode() not in ["D","F"])):#suitable for plotting...
