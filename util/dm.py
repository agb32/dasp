...
class dmInfo:
    ...
    def __init__(self,label,idlist,height,nact,fov=None,minarea=0.25,
                 ...
                 polcMatrix=None,sendFullDM=0,iirCoeffs=None):
        ...
        iirCoeffs - None, or coefficients for temporal shaping of the DM - see e.g. science/zdm.py for how these are used.
        """
