...
extern unsigned int *svd_uintArray(long size, char empty, char *name);
/* Allocates an array of doubles. */
extern double *svd_doubleArray(long size, char empty, char *name);
extern float *svd_floatArray(long size, char empty, char *name);
...
extern void svd_ffscal(long n, float da, float *dx, long incx);
extern void svd_fdscal(long n, float da, double *dx, long incx);
extern void svd_dfscal(long n, double da, float *dx, long incx);
extern void svd_fffscalnew(long n, float da, float *dx, long incx,float *dy,long incy);
extern void svd_fddscalnew(long n, float da, double *dx, long incx,double *dy,long incy);
...
extern void svd_fcopy(long n, float *dx, long incx, float *dy, long incy);
extern void svd_dfcopy(long n, double *dx, long incx, float *dy, long incy);
extern void svd_fdcopy(long n, float *dx, long incx, double *dy, long incy);
...
extern double svd_fddot(long n, float *dx, long incx, double *dy, long incy);
extern double svd_fdot(long n, float *dx, long incx, float *dy, long incy);
extern double svd_fdot_t(long n, float *dx, long incx, float *dy, long incy,int nthreads);
...
extern void svd_daxpydf (long n, double da, double *dx, long incx, float *dy, long incy);
extern void svd_daxpyfd (long n, double da, float *dx, long incx, double *dy, long incy);
extern void svd_daxpyff (long n, double da, float *dx, long incx, float *dy, long incy);
...
extern void svd_opb_t(SMat A, double *x, double *y, double *temp,int nthreads);
extern void svd_opbf(SMat A, float *x, double *y, double *temp);
extern void svd_opbf_t(SMat A, float *x, double *y, double *temp,int nthreads);
...
extern void svd_opaff(SMat A, float *x, float *y);
