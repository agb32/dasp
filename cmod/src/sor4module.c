...
static PyObject *sor4_fit(self,args)
	PyObject *self, *args;
...
static PyMethodDef sor4_methods[] = 	{
					{"fit", sor4_fit, METH_VARARGS}, 
					{NULL, NULL} };
...
void initsor4()
{
	(void) Py_InitModule("sor4", sor4_methods);
	import_array();
}
