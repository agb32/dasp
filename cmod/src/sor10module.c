...
/**************************************************************************** 
*
*  Python extension to calculate reconstructed piston values using SOR algorithm ISEGSZ
*
****************************************************************************/ 
...
static PyObject *sor10_fit(self,args)
	PyObject *self, *args;
...
static PyMethodDef sor10_methods[] = 	{
					{"fit", sor10_fit, METH_VARARGS}, 
					{NULL, NULL} };
...
void initsor10()
{
	(void) Py_InitModule("sor10", sor10_methods);
	import_array();
}
